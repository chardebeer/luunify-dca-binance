...
| MONGODB_URI             | A valid MongoDB connection string. [Learn more](https://docs.mongodb.com/manual/reference/connection-string/)                                                                                                                                                                           | mongodb://mongodb0.example.com:27017                                                      | True     |
| helloiamasecretkey      | True                                                                                                                                                                                                                                                                                    |
...
| SENTRY_PROJECT          | The slug of the project to use for a command.                                                                                                                                                                                                                                           | true                                                                                      | False    |
