...
export default class ErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <Flex align="center" direction="column" display="flex" justifyContent="center" minH="100vh" padding="10px">
          ...
          <Stack align="center" spacing={2}>
            ...
            <Button colorScheme="blue" onClick={() => window.location.reload()} textDecor="underline" variant="link">
              Refresh page
            </Button>
          </Stack>
        </Flex>
