...
const PauseIcon = createIcon({
  ...
  viewBox: '0 0 24 24',
  path: <path clipRule="evenodd" d="M10 19H6V5h4v14zm4 0V5h4v14h-4z" fill="currentColor" fillRule="evenodd" />,
});
...
type Props = {
  ...
  name: string;
  nextRun: Date;
  onButtonClick: (jobId: string, op: 'delete' | 'edit' | 'status' | 'history') => void;
  symbol: string;
  timezone: string;
};
