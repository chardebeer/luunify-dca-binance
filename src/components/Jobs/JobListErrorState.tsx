    ...
    <Flex align="center" direction="column" py={2.5}>
      ...
      <Stack align="center" spacing={5}>
        ...
        <Text color="#36454F" maxW="300px" textAlign="center">
          We seem to have run into some trouble fetching your jobs. Would you like to give it another try?
        </Text>
        <Button borderRadius="20px" colorScheme="black" isFullWidth maxW="200px" onClick={onRetry}>
          Try Again
        </Button>
      </Stack>
      <Text color="#262626" fontSize="14px" mt="40px">
        Illustration by{' '}
        <Link
          color="blue.500"
        ...
        from{' '}
        <Link color="blue.500" href="https://icons8.com/illustrations" textDecor="underline">
          Ouch!
        </Link>
      </Text>
    </Flex>
